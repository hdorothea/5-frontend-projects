...
var Controller = function () {
  function Controller() {
    var list = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : new _model.List();
    var listView = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : new _view.ListView();
    var itemInputView = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : new _view.ItemInputView();
    var filterView = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : new _view.FilterView();
  ...
  _createClass(Controller, [{
    key: 'completeOnCheck',
    value: function completeOnCheck(item, itemView) {
      var _this = this;

      itemView.checkbox.addEventListener('click', function (e) {
        if (e.target.checked) {
          item.completed = true;
    ...
    key: 'removeOnX',
    value: function removeOnX(item, itemView) {
      var _this2 = this;

      itemView.x.addEventListener('click', function () {
        _this2.list.removeItem(item);
        _this2.setLocalStorage();
        itemView.el.remove();
      });
    }
  }, {
    key: 'registerItemEvents',
    value: function registerItemEvents(item, itemView) {
      this.removeOnX(item, itemView);
      this.completeOnCheck(item, itemView);
    }
  }, {
    key: 'registerItemsEvents',
    value: function registerItemsEvents(items, itemViews) {
      var _iteratorNormalCompletion = true;
      var _didIteratorError = false;
      var _iteratorError = undefined;

      try {
        for (var _iterator = itemViews[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var itemView = _step.value;
    ...
    key: 'addNewItemOnEnter',
    value: function addNewItemOnEnter() {
      var _this3 = this;

      this.itemInputView.el.addEventListener('keypress', function (e) {
        if (e.keyCode === 13) {
          var string = e.target.value;
          var newItem = _this3.list.addItem(string);
          _this3.setLocalStorage();
          var newItemView = _this3.listView.addItem(newItem);
          _this3.registerItemEvents(newItem, newItemView);
          _this3.itemInputView.setValue('');
        }
      });
    }
  }, {
    key: 'resetListView',
    value: function resetListView(items) {
      this.listView.remove();
      this.listView = new _view.ListView(items);
      this.registerItemsEvents(items, this.listView.itemViews);
    }
  }, {
    key: 'filterOnClick',
    value: function filterOnClick() {
      var _this4 = this;

      this.filterView.allFilter.addEventListener('click', function () {
        _this4.resetListView(_this4.list.items);
        _this4.filterView.currentFilter = _this4.filterView.allFilter;
      });

      this.filterView.completedFilter.addEventListener('click', function () {
        _this4.resetListView(_this4.list.completedItems);
        _this4.filterView.currentFilter = _this4.filterView.completedFilter;
      });

      this.filterView.activeFilter.addEventListener('click', function () {
        _this4.resetListView(_this4.list.activeItems);
        _this4.filterView.currentFilter = _this4.filterView.activeFilter;
      });
    }
  }, {
    key: 'setLocalStorage',
...
var savedItems = new Map(JSON.parse(window.localStorage.getItem('items')));
if (savedItems) {
  new Controller(new _model.List(savedItems), new _view.ListView(savedItems)).run();
} else {
  new Controller().run();
}
...
exports._createItemId = _createItemId;
exports._createNewItem = _createNewItem;
...
function _createItemId(string, items) {
  var id = string;
  var freq = 0;
  while (items.has(id)) {
    freq += 1;
...
function _createNewItem(string, items) {
  var itemId = _createItemId(string, items);
  var newItem = new Item(string, itemId);
  return newItem;
}
...
var List = exports.List = function () {
  ...
  _createClass(List, [{
    key: 'addItem',
    value: function addItem(string) {
      var newItem = _createNewItem(string, this.items);
    ...
    value: function getMarkedItems() {
      var completed = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;

      var markedItems = new Map();
      var _iteratorNormalCompletion = true;
      var _didIteratorError = false;
      var _iteratorError = undefined;
...
var ItemView = exports.ItemView = function () {
  ...
  _createClass(ItemView, [{
    key: 'createStringDiv',
    value: function createStringDiv(string) {
    ...
    key: 'createItem',
    value: function createItem(string, id) {
    ...
    key: 'registerShowX',
    value: function registerShowX() {
      var _this = this;

      this.el.addEventListener('mouseover', function () {
        _this.x.style.display = 'inline';
      });
    }
  }, {
    key: 'registerHideX',
    value: function registerHideX() {
      var _this2 = this;

      this.el.addEventListener('mouseout', function () {
        _this2.x.style.display = 'none';
      });
    }
  }, {
    key: 'createX',
    value: function createX() {
...
var ListView = exports.ListView = function () {
  function ListView() {
    var items = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : new Map();
    var el = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : document.getElementById('todo-list');
  ...
  _createClass(ListView, [{
    ...
    value: function addItem(item) {
      var newItemView = new ItemView(item);
...
var ItemInputView = exports.ItemInputView = function () {
  function ItemInputView() {
    _classCallCheck(this, ItemInputView);

    this.el = document.getElementById('new-item');
  }

  _createClass(ItemInputView, [{
    key: 'getValue',
...
var FilterView = exports.FilterView = function () {
  function FilterView() {
    var allFilter = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : document.querySelector('.filter.all');
    var activeFilter = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : document.querySelector('.filter.active');
    var completedFilter = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : document.querySelector('.filter.completed');
  ...
  _createClass(FilterView, [{
    key: 'currentFilter',
    set: function set(newCurrentFilter) {
